...
create_hive_database = DataprocSubmitHiveJobOperator(
    ...
    region='us-central1',
    project_id='bigdata-project-430611',
    dag=dag
)
...
create_hive_table = DataprocSubmitHiveJobOperator(
    ...
    query="""
        ...
        STORED AS TEXTFILE
        LOCATION 'gs://logistics-raw-proj/input_data/'
...
archive_processed_file = BashOperator(
    ...
    bash_command=f"gsutil -m mv gs://logistics-raw-proj/input_data/logistics_*.csv gs://logistics-archive-proj/",
    dag=dag
)
